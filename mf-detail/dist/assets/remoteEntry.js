const currentImports = {};
      ...
      let moduleMap = {
"./PokemonDetail":()=>{
      dynamicLoadingCss([], false, './PokemonDetail');
      return __federation_import('./__federation_expose_PokemonDetail-Bs18sdjg.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__mf_detail__' + exposeItemName;
