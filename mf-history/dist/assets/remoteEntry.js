const currentImports = {};
      ...
      let moduleMap = {
"./PokemonHistory":()=>{
      dynamicLoadingCss([], false, './PokemonHistory');
      return __federation_import('./__federation_expose_PokemonHistory-CCEJg7U1.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__mf_history__' + exposeItemName;
